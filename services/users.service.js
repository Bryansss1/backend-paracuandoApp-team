...
async getUsersFilter(page,size,prop){
    try {
      let options={
        limit: Number(size),
...
const whereSet={}
if(prop.first_name){
whereSet.first_name={[Op.iLike]:prop.first_name}
}
if(prop.last_name){
whereSet.last_name={[Op.iLike]:prop.last_name}
}
if(prop.email){
whereSet.email={[Op.iLike]:prop.email}
}
if(prop.email_verified){
whereSet.email_verified=prop.email_verified
}
if(prop.phone){
whereSet.phone={[Op.iLike]:prop.phone}
}
if(prop.code_phone){
whereSet.code_phone={[Op.iLike]:prop.code_phone}  
}
if(prop.country_id){
whereSet.country_id=prop.country_id
}
if(prop.username){
whereSet.username={[Op.iLike]:prop.username} 
}
if(prop.created_at){
whereSet.created_at=prop.created_at
}
if(prop.id){
  whereSet.id=prop.id
}
...
return {Page:Number(page),totalUsers:users.count,users:users.rows}
