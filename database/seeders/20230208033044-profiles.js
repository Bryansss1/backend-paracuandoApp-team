...
module.exports = {
  async up (queryInterface, Sequelize) {
    ...
    try {
      const adminUser = await usersService.findUserByEmailOr404('bryan@academlo.com')
      const adminUser2 = await usersService.findUserByEmailOr404('daniel@academlo.com')
